...
+GeoBoundaries seeks to represent the **land mass** of administrative zones — water rights are not included.
...
+- Boundaries should always stop at the coastline (do not extend into the ocean)

+### Important Note
+
+- GeoBoundaries does **not capture maritime or water boundaries**
+- If you need boundaries that extend beyond the coast (e.g., maritime zones), refer to:
+  - marineregions.org
...
+- Boundaries stop at the coastline (no maritime boundaries included)
